...
const steps = [
  {
    ...
    description: "Choose from single videos, bundles, or custom orders. No subscriptions required.",
  },
  {
    image: editorDevelopment,
    title: "We Create",
    description: "Our editors and AI tools produce scroll-stopping content tailored to your brand.",
  },
  {
    image: creativeIntelligence,
    title: "Launch & Scale",
    description: "Get your videos delivered fast. Order more anytime — only pay for what you need.",
  },
];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Three simple steps to get scroll-stopping video ads
          </p>
        </div>
