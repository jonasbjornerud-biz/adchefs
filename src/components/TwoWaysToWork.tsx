...
const GlassCheck = () => (
  <span className="mt-0.5 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white/10 ring-1 ring-white/25 text-white backdrop-blur-md">
...
const GlassCard = ({
  ...
  <div className="relative h-full group">
    ...
    <div
      className="absolute -inset-0.5 rounded-[22px] bg-[#9ED8F5]/8 opacity-0 blur-2xl transition-opacity duration-500 group-hover:opacity-100"
      aria-hidden
    />

    <div className="relative flex flex-col h-full rounded-[20px] p-8 md:p-10 text-white overflow-hidden bg-white/[0.07] backdrop-blur-[40px] ring-1 ring-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.25),0_24px_80px_-20px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1 hover:ring-white/30">
      {/* glossy top highlight */}
      <div className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-white/20 to-transparent" aria-hidden />
      {/* faint inner accent glow */}
      <div className="pointer-events-none absolute -top-20 -right-20 h-64 w-64 rounded-full bg-[#9ED8F5]/8 blur-3xl" aria-hidden />
      <div className="pointer-events-none absolute -bottom-20 -left-20 h-64 w-64 rounded-full bg-[#9ED8F5]/8 blur-3xl" aria-hidden />
...
const TwoWaysToWork = () => {
  return (
    <section className="relative py-20 sm:py-32 overflow-hidden bg-[#0E0E10]">
      {/* minimal top-right accent wash — borrowed from hero, muted for dark */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 60% 45% at 95% 5%, rgba(158,216,245,0.10), transparent 55%), radial-gradient(ellipse 50% 40% at 5% 95%, rgba(158,216,245,0.06), transparent 55%)",
        }}
        aria-hidden
      />
